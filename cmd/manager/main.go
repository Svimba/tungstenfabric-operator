...
import (
	...
	"github.com/Svimba/tungstenfabric-operator/pkg/apis"
	"github.com/Svimba/tungstenfabric-operator/pkg/controller"
...
func main() {
	...
	if crdConfig != nil {
		log.Info(fmt.Sprintf("%+v", crdConfig.Name))
	}
	...
	// Setup register CustomResrourceDefinition
	if err := extbetav1.AddToScheme(mgr.GetScheme()); err != nil {
		log.Error(err, "")
		os.Exit(1)
	}
